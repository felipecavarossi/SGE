...
namespace SGE.Controllers
{
    public class NotasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MateriasId,AlunosId,Etapas")] Notas notas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MateriasId,AlunosId,Etapas")] Notas notas)
        {
            if (id != notas.Id)
            {
                return NotFound();
